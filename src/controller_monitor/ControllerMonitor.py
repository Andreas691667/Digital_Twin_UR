            ...
            # -- NO MESSAGE --
                ...
                if self.STATE == CMState.INITIALIZING:
                    ...
                    if (not self.robot_connection.program_running()) and (
                        ...
                        print(
                            f"Ready to take block number: {self.block_number} out of {self.task_config[GRID_CONFIG.NO_BLOCKS]-1} \n"
                        )
            ...
            # -- MESSAGE FROM DT --
                ...
                # DT could not resolve
                    ...
                    self.robot_connection.popup(
                        "DT could not resolve. Task not possible. Exiting"
                    )
                    self.STATE = CMState.SHUTTING_DOWN
                    print("\t [STATE] SHUTTING_DOWN")
