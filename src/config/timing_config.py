...
class TI_SEQUENCES:
    ...
    _block_to_block = [TIs.TYPES.BGP_TO_GP, TIs.TYPES.GRIP, TIs.TYPES.GP_TO_BGP, TIs.TYPES.BGP_TO_BTP, TIs.TYPES.BTP_TO_TP, TIs.TYPES.PARTLY_OPEN_GRIPPER, TIs.TYPES.TP_TO_BTP, TIs.TYPES.FULLY_OPEN_GRIPPER, TIs.TYPES.INITALIZATION_CODE_DELAY, TIs.TYPES.BTP_TO_BGP]
    VALUES = {
        TYPES.HOME_TO_BLOCK_TO_BLOCK: [TIs.TYPES.FULLY_OPEN_GRIPPER, TIs.TYPES.HOME_TO_BGP, *_block_to_block],
