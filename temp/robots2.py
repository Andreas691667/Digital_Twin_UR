...
class UR3e(rtb.DHRobot):
    def __init__(self):
        # TODO: Change parameters (changed accord. to UR3e)
        L1 = rtb.RevoluteMDH(d=0.15185, a=0, alpha=0)
        L2 = rtb.RevoluteMDH(d=0, a=0, alpha=pi / 2)
        L3 = rtb.RevoluteMDH(d=0, a=-0.24355, alpha=0)  # changed a to negative
        L4 = rtb.RevoluteMDH(d=0.13105, a=-0.2132, alpha=0)  # changed a to negative
...
#     # Parameters:
#     # x, y, z: coordinates from our representation
