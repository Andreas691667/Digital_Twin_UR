import pika
import threading
from rmq_config import RMQ_CONFIG
...
class Client():
    ...
    def create_channel(self):
        ...
        connection = pika.BlockingConnection(
            pika.ConnectionParameters(host=RMQ_CONFIG.RMQ_SERVER_IP, port=RMQ_CONFIG.RMQ_SERVER_PORT))
        # The channel object
    ...
    #         exchange=RMQ_CONFIG.DT_EXHANGE, exchange_type='fanout')  # for incoming messages
    ...
    def configure_outgoing_channel(self):
        ...
        self.outgoing_channel.exchange_declare(
            exchange=RMQ_CONFIG.MONITOR_EXCHANGE, exchange_type='fanout')
    ...
    def send_message(self, message):
        ...
        self.outgoing_channel.basic_publish(
            exchange=RMQ_CONFIG.MONITOR_EXCHANGE, routing_key='', body=message)
